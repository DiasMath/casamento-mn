...
export function Hero() {
  return (
    <section id="save-date" className="relative min-h-[88vh] flex items-center justify-center overflow-hidden">
      ...
      <Branch className="absolute top-0 left-0 z-10" size={140} rotate={-15} opacity={0.5} />
      <Vine className="absolute top-20 -left-8 z-10" size={120} rotate={10} opacity={0.45} />
      <Flower className="absolute top-28 left-8 sm:left-16 z-10" size={80} variant="yellow" rotate={-20} opacity={0.9} />
      <Flower className="absolute top-40 right-4 sm:right-12 z-10" size={60} variant="blue" rotate={15} opacity={0.85} />
      <Flower className="absolute top-16 right-20 z-10 hidden sm:block" size={45} variant="mixed" rotate={35} opacity={0.75} />
      <Branch className="absolute top-0 right-0 z-10" size={160} rotate={170} opacity={0.45} />
      <Flower className="absolute bottom-32 left-6 sm:left-20 z-10" size={70} variant="blue" rotate={-25} opacity={0.85} />
      <Flower className="absolute bottom-20 right-8 sm:right-24 z-10" size={55} variant="yellow" rotate={40} opacity={0.8} />
      <Flower className="absolute bottom-40 right-16 z-10 hidden sm:block" size={40} variant="mixed" rotate={-15} opacity={0.7} />
      <Branch className="absolute bottom-0 left-0 z-10" size={180} rotate={-5} opacity={0.4} />
      <Vine className="absolute bottom-0 right-0 z-10" size={100} rotate={-10} opacity={0.35} />
